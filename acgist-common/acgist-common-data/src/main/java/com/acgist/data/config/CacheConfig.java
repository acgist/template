...
public class CacheConfig {
	...
	public CacheManager cacheManager(RedisConnectionFactory factory) {
		...
		final RedisCacheConfiguration config = RedisCacheConfiguration
			.defaultCacheConfig()
			// 序列化：key
			.serializeKeysWith(RedisSerializationContext.SerializationPair.fromSerializer(RedisConfig.buildKeySerializer()))
			// 序列化：value
			.serializeValuesWith(RedisSerializationContext.SerializationPair.fromSerializer(RedisConfig.buildValueSerializer()))
