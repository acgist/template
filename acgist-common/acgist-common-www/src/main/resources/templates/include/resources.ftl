<link rel="stylesheet" type="text/css" href="${staticBase}/resources/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="${staticBase}/resources/css/style.css" />
