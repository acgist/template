...
public class GatewayMappingConfig {
	...
	public void config() {
		...
		mapping.register(new GatewayType(true, false, "用户信息查询", "/gateway/user", HttpMethod.GET, UserRequest.class, UserResponse.class));
		mapping.register(new GatewayType(true, false, "用户昵称修改", "/gateway/user/nick", HttpMethod.PUT, UserNickRequest.class, UserNickResponse.class));
	}
