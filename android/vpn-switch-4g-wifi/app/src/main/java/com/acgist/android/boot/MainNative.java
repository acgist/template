...
public class MainNative {
     ...
     */
    public static boolean startTun2Socks(LogLevel logLevel, ParcelFileDescriptor vpnInterfaceFileDescriptor, int vpnInterfaceMtu, String socksServerAddress, int socksServerPort, String netIPv4Address, @Nullable String netIPv6Address, String netmask, boolean forwardUdp) {
        ...
        Log.i("route", "tun2socks: " + arguments);
     ...
     */
    public static native int start_tun2socks(String[] args);
